...
class ServerAdapter(object):
    quiet = False
    def __init__(self, host='0.0.0.0', port=80, **options):
...
_debug = debug
def run(app=None, server='wsgiref', host='0.0.0.0', port=80,
        interval=0, reloader=False, quiet=False, plugins=None,
        debug=None, **kargs):
    """ Start a server instance. This method blocks until the server terminates.
        ...
        :param host: Server address to bind to. Pass ``0.0.0.0`` to listens on
               all interfaces including the external one. (default: 0.0.0.0)
        :param port: Server port to bind to. Values below 1024 require root
               privileges. (default: 80)
...
if __name__ == '__main__':
    ...
    host, port = (opt.bind or '0.0.0.0'), 80
